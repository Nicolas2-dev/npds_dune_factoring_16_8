...
use Npds\Contracts\Language\LanguageInterface;
...
class Language implements LanguageInterface
{
     ...
     * &agrave; la langue / [transl] ... [/transl] permet de simuler un appel translate("xxxx")
     *
     ...
     * @return  [type]               [return description]
     */
    public static function aff_local_langue($ibid_index, $ibid, $mess = '')
    {
        global $REQUEST_URI;
    ...
    /**
     * renvoi le code language iso 639-1 et code pays ISO 3166-2 $l=> 0 ou 1(requis), $s (séparateur - | _) , $c=> 0 ou 1 (requis)
     *
