...
use Npds\Contracts\Pixel\DataImageInterface;


/**
 * DataImage class
 */
class DataImage implements DataImageInterface
{
    /**
    ...
    /**
     * Analyse la chaine $base_64_string pour touver "src data:image" SI oui : fabrication de fichiers (gif | png | jpeg) (avec $output_path)
     * redimensionne l'image si supérieure aux dimensions maxi fixées et remplacement de "src data:image" par "src url", et retourne $base_64_string modifié ou pas
     *
     ...
     * @return  [type]                   [return description]
     */
    public static function dataimagetofileurl($base_64_string, $output_path)
    {
