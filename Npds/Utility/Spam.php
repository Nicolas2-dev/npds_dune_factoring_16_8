...
class Spam 
{
    ...
    /**
     * [spam_log description]
     *
     * @return  [type]  [return description]
     */
    public static function spam_log()
    {
    ...
    /**
     * forge un champ de formulaire (champ de saisie : $asb_reponse
     * champ hidden : asb_question) permettant de déployer une fonction anti-spambot
     *
     * @return  [type]  [return description]
     */
    public static function Q_spambot()
    {
        ...
        //  Deprecated: Implicit conversion from float 523997.00000000006 to int loses precision in 
        // F:\NEW DEV\dev_revolution_jpb\npds_dune-master\revolution_16\mainfile.php on line 1807
        $rand = (float) microtime();

        // START ALEA
        mt_srand($rand * 1000000);
    ...
    /**
     * valide le champ $asb_question avec la valeur de $asb_reponse (anti-spambot) et filtre le contenu de $message si nécessaire
     *
