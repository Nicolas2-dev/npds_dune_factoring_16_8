...
$m->add_comment(Language::aff_langue('<div class="row"><p class="lead">[french]En savoir plus[/french][english]More[/english][spanish]M&#xE1;s[/spanish][german]Mehr[/german]</p></div>'));
$m->add_field('C1', Language::aff_langue('[french]Activit&#x00E9; professionnelle[/french][english]Professional activity[/english][spanish]Actividad profesional[/spanish][german]Berufliche T&#xE4;tigkeit[/german]'), $C1, 'text', false, 100, '', '');
$m->add_extender('C1', '', '<span class="help-block text-end" id="countcar_C1"></span>');
$m->add_field('C2', Language::aff_langue('[french]Code postal[/french][english]Postal code[/english][spanish]C&#xF3;digo postal[/spanish][german]Postleitzahl[/german]'), $C2, 'text', false, 5, '', '');
$m->add_extender('C2', '', '<span class="help-block text-end" id="countcar_C2"></span>');
$m->add_date('T1', Language::aff_langue('[french]Date de naissance[/french][english]Birth date[/english][spanish]Fecha de nacimiento[/spanish][german]Geburtsdatum[/german]'), $T1, 'text', '', false, 20);
...
$m->add_field($ch_lat, Language::aff_langue('[french]Latitude[/french][english]Latitude[/english][chinese]&#x7ECF;&#x5EA6;[/chinese][spanish]Latitud[/spanish][german]Breitengrad[/german]'), $$ch_lat, 'text', false, '', '', 'lat');
$m->add_field($ch_lon, Language::aff_langue('[french]Longitude[/french][english]Longitude[/english][chinese]&#x7EAC;&#x5EA6;[/chinese][spanish]Longitud[/spanish][german]L&#228;ngengrad[/german]'), $$ch_lon, 'text', false, '', '', 'long');
