...
if ($submitS) {
    ...
    if ($stop != 1) {
        ...
        $sql = "INSERT INTO " . sql_table('posts') . " (topic_id, image, forum_id, poster_id, post_text, post_time, poster_ip, poster_dns, post_idH) 
    ...
    list($topic_title, $topic_status) = sql_fetch_row(sql_query("select topic_title, topic_status from " . sql_table('forumtopics') . " where topic_id='$topic'"));
