...
$Q = sql_query("SELECT def, content, type_meta, type_uri, uri, description FROM " . sql_table('metalang') . " ORDER BY 'type_meta','def' ASC");
...
\" title=\"Cliquer pour utiliser ce méta-mot dans votre texte.\">$def</a>";
    ...
    if ($type_meta == "smil") {
        ...
        echo '
            <td valign="top" align="left">' . Language::aff_langue($description) . '</td>
         </tr>';
        }
