...
$result = sql_query("SELECT COUNT(*) AS total FROM " . sql_table('posts') . " WHERE forum_id='$forum' AND topic_id='$topic' AND post_aff='1'");
...
$sql = "SELECT * FROM " . sql_table('posts') . " WHERE forum_id='$forum' AND topic_id = '$topic'" . $post_aff . "ORDER BY post_id LIMIT $C_start, $comments_per_page";
