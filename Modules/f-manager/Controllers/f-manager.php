        ...
        if (!file_exists("modules/$ModPath/users/" . strtolower($FmaRep) . ".conf.php")) {
            ...
            if ($tab_groupe) {
                ...
                foreach ($tab_groupe as $gp) {
                    ...
                    $groupename = Q_select("SELECT groupe_name FROM " . sql_table('groupes') . " WHERE groupe_id='$gp' ORDER BY `groupe_id` ASC", 3600);
...
switch ($op) {
    case 'upload':
        if ($ficcmd_fma[0]) {
            if ($userfile != 'none') {
                ...
                include_once("modules/upload/Suport/clsUpload.php");
                ...
                if ($filename) {
                    ...
                    if ($auto[0]) {
                        if (!$upload->saveAs($auto[2], $base . '/', 'userfile', true))
                            ...
                            Log::Ecr_Log('security', 'Upload File', $log_dir . '/' . $filename . ' IP=>' . getip());
                    } else
                        $Err = $auto[1];
                }
            }
        ...
        if ($dircmd_fma[0]) {
            ...
            if ($auto[0]) {
                if (!$obj->Create('d', $base . '/' . $auto[2]))
                    ...
                    Log::Ecr_Log('security', 'Create Directory', $log_dir . '/' . $userdir . ' IP=>' . getip());
            ...
            if ($auto[0]) {
                ...
                if ($autoD[0]) {
                    ...
                    if (!$obj->Rename($auto[3] . '/' . $auto[2], $auto[3] . '/' . $autoD[2]))
                        ...
                        Log::Ecr_Log('security', 'Rename Directory', $log_dir . '/' . $autoD[2] . ' IP=>' . getip());
                } else
                    $Err = $autoD[1];
            } else
                $Err = $auto[1];
        ...
        if ($dircmd_fma[2]) {
            ...
            if ($auto[0]) {
                ...
                if (!$obj->RemoveDir($auto[3] . '/' . $auto[2])) {
                    ...
                    Log::Ecr_Log('security', 'Delete Directory', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
            } else
                $Err = $auto[1];
        }
        break;
            ...
            if ($auto[0]) {
                ...
                if (file_exists($auto[3] . '/' . $auto[2])) {
                    ...
                    if (!$obj->ChgPerms($auto[3] . '/' . $auto[2], $chmoddir))
                        ...
                        Log::Ecr_Log('security', 'Chmod Directory', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
                }
            } else
                $Err = $auto[1];
        }
        ...
        if ($ficcmd_fma[0]) {
            ...
            if ($auto[0]) {
                if (!$obj->Create('f', $base . '/' . $auto[2]))
                    ...
                    Log::Ecr_Log('security', 'Create File', $log_dir . '/' . $userfile . ' IP=>' . getip());
            } else
                $Err = $auto[1];
        }
        break;
            ...
            if ($auto[0]) {
                ...
                if ($autoD[0]) {
                    ...
                    if (!$obj->Rename($auto[3] . '/' . $auto[2], $auto[3] . '/' . $autoD[2]))
                        ...
                        Log::Ecr_Log('security', 'Rename File', $log_dir . '/' . $autoD[2] . ' IP=>' . getip());
                } else
                    $Err = $autoD[1];
            } else
                $Err = $auto[1];
        ...
        if ($ficcmd_fma[1]) {
            ...
            if ($auto[0]) {
                ...
                if (!$obj->Move($auto[3] . '/' . $auto[2], $basedir_fma . $movefile . "/" . $auto[2]))
                    ...
                    Log::Ecr_Log('security', 'Move File', $log_dir . '/' . $auto[2] . ' TO ' . $movefile . '/' . $auto[2] . ' IP=>' . getip());
            } else
                $Err = $auto[1];
        }
        break;
        ...
        if ($ficcmd_fma[1]) {
            ...
            if ($auto[0]) {
                ...
                if (!$obj->Copy($auto[3] . '/' . $auto[2], $basedir_fma . $movefile . '/' . $auto[2]))
                    ...
                    Log::Ecr_Log('security', 'Copy File', $log_dir . '/' . $auto[2] . ' TO ' . $movefile . '/' . $auto[2] . ' IP=>' . getip());
            } else
                $Err = $auto[1];
        }
        break;
        ...
        if ($ficcmd_fma[2]) {
            ...
            if ($auto[0]) {
                ...
                if (!$obj->Remove($auto[3] . '/' . $auto[2]))
                    ...
                    Log::Ecr_Log('security', 'Delete File', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
            } else
                $Err = $auto[1];
        }
        break;
            ...
            if ($auto[0]) {
                ...
                if (file_exists($auto[3] . '/' . $auto[2])) {
                    ...
                    if (!$obj->ChgPerms($auto[3] . '/' . $auto[2], $chmodfile))
                        ...
                        Log::Ecr_Log('security', 'Chmod File', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
                }
            } else
                $Err = $auto[1];
        }
            ...
            if ($auto[0]) {
                ...
                if (file_exists($auto[3] . '/' . $auto[2])) {
                    ...
                    if (in_array($suffix, $tabW))
                        $edit_file .= Editeur::fetch('editfile', 'true');
            ...
            if ($auto[0]) {
                ...
                if (in_array($suffix, $tabW)) {
                    ...
                    if (file_exists($auto[3] . '/' . $auto[2])) {
                        ...
                        Log::Ecr_Log('security', 'Edit File', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
                    }
                } else
                    Log::Ecr_Log('security', 'Edit File forbidden', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
            } else
                $Err = $auto[1];
        }
    ...
    case 'pict-save':
        ...
        if ($auto[0]) {
            ...
            Log::Ecr_Log('security', 'Pic-Manager', $log_dir . '/' . $auto[2] . ' IP=>' . getip());
        } else
            $Err = $auto[1];
        break;
