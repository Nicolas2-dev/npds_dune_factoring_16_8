...
function ForumGo($cat_id)
{
    ...
    while (list($forum_id, $forum_name, $forum_access, $forum_moderator, $forum_type, $arbre, $attachement, $forum_index) = sql_fetch_row($result)) {
        ...
        switch ($forum_access) {
            ...
            case (1):
                echo '<td>' . adm_translate("Utilisateur enregistré") . '</td>';
                break;

            case (2):
                echo '<td>' . adm_translate("Modérateurs") . '</td>';
                break;

            case (9):
                echo '<td>Forum ' . adm_translate("Fermé") . '</td>';
                break;
        }
...
function ForumGoEdit($forum_id, $ctg)
{
    ...
    $moderator = str_replace(' ', ',', User::get_moderator($forum_mod));
...
function ForumCatSave($old_catid, $cat_id, $cat_title)
{
    ...
    global $aid;
    Log::Ecr_Log("security", "UpdateForumCat($old_catid, $cat_id, $cat_title) by AID : $aid", '');
...
function ForumGoSave($forum_id, $forum_name, $forum_desc, $forum_access, $forum_mod, $cat_id, $forum_type, $forum_pass, $arbre, $attachement, $forum_index, $ctg)
{
    ...
    if ($error_mod != '') {
        ...
        global $aid;
        Log::Ecr_Log("security", "UpdateForum($forum_id, $forum_name) by AID : $aid", '');
...
function ForumGoAdd($forum_name, $forum_desc, $forum_access, $forum_mod, $cat_id, $forum_type, $forum_pass, $arbre, $attachement, $forum_index, $ctg)
{
    ...
    if ($error_mod != '') {
        ...
        global $aid;
        Log::Ecr_Log("security", "AddForum($forum_name) by AID : $aid", "");
...
function ForumCatDel($cat_id, $ok = 0)
{
    ...
    if ($ok == 1) {
        ...
        global $aid;
        Log::Ecr_Log("security", "DeleteForumCat($cat_id) by AID : $aid", "");
...
function ForumGoDel($forum_id, $ok = 0)
{
    ...
    if ($ok == 1) {
        ...
        global $aid;
        Log::Ecr_Log('security', "DeleteForum($forum_id) by AID : $aid", '');
