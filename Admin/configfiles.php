 ...
 *
 * @param   [type]  $Xtxt    [$Xtxt description]
 * @param   [type]  $Xfiles  [$Xfiles description]
 *
 * @return  [type]           [return description]
 */
function ConfigFiles_save($Xtxt, $Xfiles)
{
    ...
    global $aid;
    Log::Ecr_Log('security', "SaveConfigFile($Xfiles) by AID : $aid", '');
 ...
 *
 * @param   [type]  $fileX  [$fileX description]
 *
 * @return  [type]          [return description]
 */
 ...
 *
 * @param   [type]  $modele  [$modele description]
 *
 * @return  [type]           [return description]
 */
function ConfigFiles_delete($modele)
{
    ...
    global $aid;
    Log::Ecr_Log('security', "DeleteConfigFile($modele) by AID : $aid", '');
...
function ConfigFiles_create($modele)
{
    ...
    global $aid;
    Log::Ecr_Log('security', "CreateConfigFile($modele) by AID : $aid", '');
