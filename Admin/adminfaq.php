...
function FaqCatGo($id_cat)
{
    ...
    $result = sql_query("SELECT fa.id, fa.question, fa.answer, fc.categories 
                         ...
                         LEFT JOIN " . sql_table('faqcategories') . " fc 
                         ON fa.id_cat = fc.id_cat 
                         WHERE fa.id_cat='$id_cat' 
                         ORDER BY id");
    ...
    echo Editeur::fetch("answer", "false");
...
function FaqCatSave($old_id_cat, $id_cat, $categories)
{
    ...
    if ($old_id_cat != $id_cat) {
        sql_query("UPDATE " . sql_table('faqanswer') . " 
                   SET id_cat='$id_cat' 
                   WHERE id_cat='$old_id_cat'");
    }

    sql_query("UPDATE " . sql_table('faqcategories') . " 
...
function FaqCatGoAdd($id_cat, $question, $answer)
{
    ...
    sql_query("INSERT INTO " . sql_table('faqanswer') . " 
