...
switch ($op) {
    case 'supercache_save':
        ...
        global $aid;
        Log::Ecr_Log('security', "ChangeSuperCache($xsupercache, $xt_index, $xt_article, $xt_sections, $xt_faq, $xt_links, $xt_forum, $xt_memberlist, $xt_modules) by AID : $aid", '');
    ...
    case 'supercache_empty':
        ...
        Log::Ecr_Log('security', "EmptySuperCache() by AID : $aid", '');
        Header("Location: admin.php?op=supercache");
        break;
