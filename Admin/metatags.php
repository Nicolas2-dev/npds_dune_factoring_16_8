 ...
 *
 * @param   [type]  $filename  [$filename description]
 * @param   [type]  $tags      [$tags description]
 *
 * @return  [type]             [return description]
 */
function MetaTagSave($filename, $tags)
{
    ...
    if ($fh) {
        ...
        $content .= MetaTagMakeSingleTag('og:image', '$nuke_url/assets/images/ogimg.jpg', 'property');
        ...
        global $aid;
        Log::Ecr_Log('security', "MetaTagsave() by AID : $aid", '');
